...
TSS_RESULT keyGetKeyByUUID(TSS_HCONTEXT a_hContext,
			   ...
			   TSS_UUID a_uKeyId, TSS_HKEY * a_hKey);
//add by cosmoslx
TSS_RESULT keyRegisterKey(TSS_HCONTEXT a_hContext,TSS_HKEY a_hKey,
		TSS_UUID a_uKeyId,TSS_UUID a_pKeyId);

TSS_RESULT keyUnregisterKey(TSS_HCONTEXT a_hContext,TSS_UUID a_uKeyId);
// end
